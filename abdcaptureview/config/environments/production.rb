Rails.application.configure do
  ...
  config.action_mailer.default_options = {
    from: ENV.fetch("EMAIL_MAIL_FROM", "ABDCaptureview <notifications@abdcaptureview.pages.dev>"),
    reply_to: ENV.fetch("EMAIL_MAIL_REPLY_TO", ENV.fetch("EMAIL_MAIL_FROM", "ABDCaptureview <notifications@abdcaptureview.pages.dev>"))
  }
